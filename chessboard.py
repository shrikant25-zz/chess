...
class Board():
    ...
    def create_pieces(self): 
        ...
        self.pieces_list.append(Pieces("white_rook1", 7, 0))
        self.pieces_list.append(Pieces("white_knight1", 7, 1))
        self.pieces_list.append(Pieces("white_bishop1", 7, 2))
        self.pieces_list.append(Pieces("white_queen", 7, 3))
        self.pieces_list.append(Pieces("white_king", 7, 4))
        self.pieces_list.append(Pieces("white_bishop2", 7, 5))
        self.pieces_list.append(Pieces("white_knight2", 7, 6))
        self.pieces_list.append(Pieces("white_rook2", 7, 7))
        ...
        self.pieces_list.append(Pieces("black_rook1", 0, 0))
        self.pieces_list.append(Pieces("black_knight1", 0, 1))
        self.pieces_list.append(Pieces("black_bishop1", 0, 2))
        self.pieces_list.append(Pieces("black_queen", 0, 3))
        self.pieces_list.append(Pieces("black_king", 0, 4))
        self.pieces_list.append(Pieces("black_bishop2", 0, 5))
        self.pieces_list.append(Pieces("black_knight2", 0, 6))
        self.pieces_list.append(Pieces("black_rook2", 0, 7))
